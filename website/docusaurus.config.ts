...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'v1_release',
      content:
        '🎉 <strong>SafeLicensing v1.0.1</strong> is live on PyPI — <a href="https://pypi.org/project/safelicensing/" target="_blank" rel="noopener noreferrer">pip install safelicensing</a>',
